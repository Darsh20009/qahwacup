...
const PICKUP_RADIUS_METERS = 500;
...
export default function MapAddressSelector({
  ...
  const canConfirm = position && selectedOrderType !== null && (
    (selectedOrderType === "delivery" && canDelivery) ||
    (selectedOrderType === "pickup" && canPickup)
  );
                    ...
                    <p className="text-sm text-red-600 dark:text-red-300 mt-1">
                      {pickupInfo?.nearestBranch ? (
                        <>
                          ...
                          <br />
                          الاستلام متاح ضمن نطاق {PICKUP_RADIUS_METERS} متر من الفرع
                        </>
                      ) : (
                        "لا تتوفر خدمة التوصيل أو الاستلام في هذه المنطقة"
                      )}
                    </p>
                  </div>
                </div>
              ...
              >
                <Popup>
                  <div className="text-right">
                    ...
                    <p className="text-sm">نطاق الاستلام: {PICKUP_RADIUS_METERS} متر</p>
                  </div>
                </Popup>
              </Circle>
            ))}
      ...
      <div className="bg-muted/50 p-3 rounded-lg space-y-2">
        <div className="flex items-center justify-center gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs text-muted-foreground">نطاق الاستلام (500م)</p>
          </div>
        </div>
      </div>
    </div>
