...
export class MemStorage implements IStorage {
  ...
  private initializeCoffeeMenu() {
    const coffeeMenuData: CoffeeItem[] = [
      ...
      { id: "coffee-day-hot", nameAr: "قهوة اليوم (حار)", nameEn: "Coffee of the Day Hot", description: "تشكيلة مختارة يومياً من أفضل حبوب القهوة", price: "4.95", oldPrice: "5.50", category: "hot", imageUrl: "/attached_assets/Screenshot 2025-09-09 192022_1757685132648.png", isAvailable: 1 },
      ...
      { id: "coffee-day-cold", nameAr: "قهوة اليوم (بارد)", nameEn: "Coffee of the Day Cold", description: "تشكيلة مختارة يومياً من القهوة الباردة المنعشة", price: "4.95", oldPrice: "5.50", category: "cold", imageUrl: "/attached_assets/Screenshot 2025-09-09 192058_1757434923572.png", isAvailable: 1 },
    ];
