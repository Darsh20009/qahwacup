...
interface DrinkIngredientWithQuantity {
  ingredient: string;
  quantity: number;
  unit: string;
}

const drinkIngredients: Record<string, DrinkIngredientWithQuantity[]> = {
  "espresso-single": [
    { ingredient: "قهوة إسبريسو", quantity: 30, unit: "ml" }
  ],
  "espresso-double": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" }
  ],
  "americano": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "ماء ساخن", quantity: 180, unit: "ml" }
  ],
  "ristretto": [
    { ingredient: "قهوة إسبريسو", quantity: 20, unit: "ml" }
  ],
  "turkish-coffee": [
    { ingredient: "قهوة تركية", quantity: 10, unit: "g" },
    { ingredient: "ماء ساخن", quantity: 100, unit: "ml" }
  ],
  "cafe-latte": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "حليب", quantity: 180, unit: "ml" },
    { ingredient: "رغوة الحليب", quantity: 20, unit: "ml" }
  ],
  "cappuccino": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "حليب", quantity: 120, unit: "ml" },
    { ingredient: "رغوة الحليب", quantity: 60, unit: "ml" }
  ],
  "vanilla-latte": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "حليب", quantity: 150, unit: "ml" },
    { ingredient: "فانيلا", quantity: 25, unit: "ml" },
    { ingredient: "رغوة الحليب", quantity: 20, unit: "ml" }
  ],
  "mocha": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "حليب", quantity: 150, unit: "ml" },
    { ingredient: "شوكولاتة", quantity: 25, unit: "ml" },
    { ingredient: "كريمة مخفوقة", quantity: 30, unit: "ml" }
  ],
  "con-panna": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "كريمة مخفوقة", quantity: 30, unit: "ml" }
  ...
  "french-press": [
    { ingredient: "قهوة فرنسية", quantity: 15, unit: "g" },
    { ingredient: "ماء ساخن", quantity: 240, unit: "ml" }
  ],
  "coffee-day-hot": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "حليب", quantity: 150, unit: "ml" },
    { ingredient: "كراميل", quantity: 25, unit: "ml" }
  ],
  "hot-tea": [
    { ingredient: "شاي", quantity: 3, unit: "g" },
    { ingredient: "ماء ساخن", quantity: 240, unit: "ml" }
  ],
  "ice-tea": [
    { ingredient: "شاي", quantity: 3, unit: "g" },
    { ingredient: "ثلج", quantity: 100, unit: "g" }
  ],
  "iced-matcha-latte": [
    { ingredient: "ماتشا", quantity: 3, unit: "g" },
    { ingredient: "حليب", quantity: 180, unit: "ml" },
    { ingredient: "ثلج", quantity: 100, unit: "g" }
  ],
  "hot-matcha-latte": [
    { ingredient: "ماتشا", quantity: 3, unit: "g" },
    { ingredient: "حليب", quantity: 200, unit: "ml" }
  ],
  "iced-latte": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "حليب", quantity: 150, unit: "ml" },
  ...
  "iced-mocha": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "حليب", quantity: 130, unit: "ml" },
    { ingredient: "شوكولاتة", quantity: 25, unit: "ml" },
    { ingredient: "ثلج", quantity: 100, unit: "g" },
    { ingredient: "كريمة مخفوقة", quantity: 30, unit: "ml" }
  ],
  "iced-cappuccino": [
    ...
    { ingredient: "حليب", quantity: 120, unit: "ml" },
    { ingredient: "ثلج", quantity: 100, unit: "g" },
    { ingredient: "رغوة الحليب", quantity: 40, unit: "ml" }
  ],
  "iced-condensed": [
    { ingredient: "قهوة إسبريسو", quantity: 60, unit: "ml" },
    { ingredient: "حليب مكثف", quantity: 30, unit: "ml" },
    { ingredient: "ثلج", quantity: 100, unit: "g" }
  ],
  "vanilla-cold-brew": [
    { ingredient: "قهوة كولد برو", quantity: 120, unit: "ml" },
    { ingredient: "فانيلا", quantity: 25, unit: "ml" },
    { ingredient: "ثلج", quantity: 100, unit: "g" }
  ],
  "cold-brew": [
    { ingredient: "قهوة كولد برو", quantity: 180, unit: "ml" },
    { ingredient: "ثلج", quantity: 100, unit: "g" }
  ],
  "coffee-day-cold": [
    { ingredient: "قهوة كولد برو", quantity: 120, unit: "ml" },
    { ingredient: "حليب", quantity: 100, unit: "ml" },
    { ingredient: "ثلج", quantity: 100, unit: "g" }
  ],
  "coffee-dessert-cup": [
    { ingredient: "قهوة إسبريسو", quantity: 30, unit: "ml" },
    { ingredient: "كريمة", quantity: 50, unit: "ml" },
    { ingredient: "بسكويت مطحون", quantity: 20, unit: "g" },
    { ingredient: "شوكولاتة", quantity: 20, unit: "ml" }
  ]
};
...
export async function linkDrinkIngredients(ingredientMap: Map<string, string>) {
  ...
  for (const [drinkId, ingredientList] of Object.entries(drinkIngredients)) {
    try {
      for (const { ingredient, quantity, unit } of ingredientList) {
        const ingredientId = ingredientMap.get(ingredient);
        if (ingredientId) {
          try {
            await storage.addCoffeeItemIngredient(drinkId, ingredientId, quantity, unit);
          } catch (error: any) {
            if (error.code !== 11000) {
              console.error(`❌ Error linking ${drinkId} with ${ingredient}:`, error);
            }
          }
        }
      }
