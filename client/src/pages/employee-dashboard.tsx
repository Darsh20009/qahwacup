...
export default function EmployeeDashboard() {
 ...
 useEffect(() => {
 if (employee?.id) {
 // Use full employee ID for QR code (permanent, never changes)
 generateQRCode(employee.id);
 }
 }, [employee?.id]);

 // Generate QR code with full employee ID (permanent, never changes)
 ...
 <Button
 size="lg"
 className="h-32 flex flex-col items-center justify-center gap-3 bg-gradient-to-br from-cyan-600 to-cyan-800 hover:from-cyan-700 hover:to-cyan-900 text-white"
