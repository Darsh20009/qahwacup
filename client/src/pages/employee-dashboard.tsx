...
export default function EmployeeDashboard() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-amber-500">قهو� كوب</h1>
 ...
 <h3 className="text-white font-bold text-xl">قهو� كوب</h3>
 <p className="text-white/90 text-sm">بطاق� موظف</p>
 </div>
 </div>
 ...
 يتم إرسال الفاتور� تلقائياً للعميل عبر واتساب
 </p>
 <p className="flex items-center gap-2">
 <span className="w-2 h-2 bg-purple-500 rounded-full" />
 يمكنك متابع� حال� الطلبات وتحديثها من صفح� إدار� الطلبات
 </p>
 <p className="flex items-center gap-2">
 <span className="w-2 h-2 bg-amber-500 rounded-full" />
