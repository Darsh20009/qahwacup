...
export default function EmployeeMenuManagement() {
 ...
 description: error.message || "حدث � طأ أثناء إضاف� المشروب",
 });
 },
 });
 ...
 variant: "destructive",
 title: "فشل التحديث",
 description: error.message || "حدث � طأ أثناء تحديث المشروب",
 });
 },
 });
 ...
 variant: "destructive",
 title: "فشل الحذف",
 description: error.message || "حدث � طأ أثناء حذف المشروب",
 });
 },
 });
 ...
 variant: "destructive",
 title: "فشل التحديث",
 description: error.message || "حدث � طأ أثناء التحديث",
 });
 },
 });
 ...
 <SelectItem value="basic">قهو� أساسي� </SelectItem>
 <SelectItem value="hot">قهو� سا� ن� </SelectItem>
 <SelectItem value="cold">قهو� بارد� </SelectItem>
 ...
 <option value="out_of_stock">❌ نفذت الكمي� </option>
