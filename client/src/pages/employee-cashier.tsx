...
export default function EmployeeCashier() {
 ...
 toast({
 title: "� طأ",
 description: "يرجى إد� ال كود ال� صم",
 variant: "destructive",
 });
 return;
 }
 ...
 toast({
 title: "� طأ",
 description: "يرجى إد� ال بيانات العميل",
 variant: "destructive",
 });
 return;
 }
 ...
 <span className="text-amber-300 font-semibold">بطاق� كوبي</span>
 </div>
 ...
 <span className="text-green-400">كود ال� صم (ا� تياري)</span>
 <Gift className="w-5 h-5 text-green-400" />
 </Label>
 <p className="text-xs text-gray-400 text-right mb-2">
 هل لديك كود � صم؟ أد� له هنا للحصول على ت� فيض فوري
 </p>
 {!appliedDiscount ? (
