...
export default function MenuPage() {
 ...
 { id: "basic", nameAr: "قهو� أساسي� ", nameEn: "Basic Coffee", icon: Coffee },
 { id: "hot", nameAr: "قهو� سا� ن� ", nameEn: "Hot Coffee", icon: Flame },
 { id: "cold", nameAr: "قهو� بارد� ", nameEn: "Cold Coffee", icon: Snowflake },
 { id: "specialty", nameAr: "المشروبات الإضافي� ", nameEn: "Specialty Drinks", icon: Star },
 ...
 { id: "mild" as const, labelAr: "� فيف (1-4)", icon: "🌱" },
 ...
 <p className="text-muted-foreground text-xl">أفضل ما لدينا من القهو� الطازج� </p>
 ...
 <p className="text-xs sm:text-sm text-slate-500 hidden sm:block">تجرب� قهو� استثنائي� </p>
 </div>
 </div>
 ...
 {isAuthenticated ? "بطاق� كوبي" : "تسجيل الد� ول"}
 </span>
 </Button>
 ...
 <span className="hidden sm:inline">السل� </span>
 {totalItems > 0 && (
 <Badge 
 variant="destructive" 
 ...
 انطلق في رحل� قهو� استثنائي� مع تشكيلتنا الم� تار� بعناي� من أجود حبوب القهو� العربي� الأصيل� ، 
 محضر� بحرفي� عالي� لتقدم لك تجرب� لا تُنسى مع كل رشف� 
 </p>
 ...
 >
 <span className="ml-1 sm:ml-2 text-sm sm:text-base md:text-lg">{strength.icon}</span>
 ...
 لم نجد أي منتجات في هذه الفئ� حالياً
 </p>
 </div>
 )}
 </div>)
