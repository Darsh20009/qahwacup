...
export default function ManagerDrivers() {
  ...
  const toggleAvailabilityMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "تم التحديث",
        description: "تم تحديث حالة توفر السائق",
      });
    },
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1a1410] via-[#2d1f1a] to-[#1a1410] p-4">
      ...
      <div className="max-w-7xl mx-auto mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-amber-500">إدارة السائقين</h1>
              <p className="text-gray-400 text-sm">إضافة وتعديل حسابات السائقين</p>
            </div>
          </div>
                ...
                <CardContent className="space-y-3">
                  <div className="space-y-2">
                    ...
                    <div className="bg-[#1a1410] p-2 rounded-lg">
                      <p className="text-xs text-gray-400">لوحة المركبة</p>
                    ...
                    {driver.licenseNumber && (
                      <div className="bg-[#1a1410] p-2 rounded-lg">
                        <p className="text-xs text-gray-400">رقم الرخصة</p>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="bg-[#2d1f1a] border-amber-500/20 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-amber-500">إضافة سائق جديد</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleSubmitNewDriver} className="space-y-4">
            ...
            <div className="border-t border-amber-500/20 pt-4">
              <h3 className="text-amber-400 font-semibold mb-3">معلومات المركبة</h3>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="vehicleType" className="text-gray-300">نوع المركبة *</Label>
                  <Select name="vehicleType" required>
                    ...
                    <SelectContent className="bg-[#2d1f1a] border-amber-500/20 text-white">
                      ...
                      <SelectItem value="دراجة كهربائية">دراجة كهربائية</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div>
                  <Label htmlFor="vehicleColor" className="text-gray-300">لون المركبة *</Label>
                  <Input
                    id="vehicleColor"
                    name="vehicleColor"
                    required
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <div>
                  <Label htmlFor="vehiclePlateNumber" className="text-gray-300">رقم اللوحة *</Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="licenseNumber" className="text-gray-300">رقم الرخصة</Label>
                  <Input
                    id="licenseNumber"
                    name="licenseNumber"
                    className="bg-[#1a1410] border-amber-500/30 text-white font-mono"
          ...
          {editingDriver && (
            <form onSubmit={handleSubmitEditDriver} className="space-y-4">
              ...
              <div className="border-t border-amber-500/20 pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="edit-vehicleType" className="text-gray-300">نوع المركبة *</Label>
                  ...
                  <div>
                    <Label htmlFor="edit-vehicleColor" className="text-gray-300">لون المركبة *</Label>
                    <Input
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
                    <Label htmlFor="edit-vehiclePlateNumber" className="text-gray-300">رقم اللوحة *</Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="edit-licenseNumber" className="text-gray-300">رقم الرخصة</Label>
                    <Input
