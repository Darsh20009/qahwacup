...
export default function MenuView() {
 ...
 <h1 className="font-amiri text-lg md:text-2xl font-bold text-primary">قائم� القهو� الف� م� </h1>
 </div>
 ...
 أجود أنواع القهو� العربي� الأصيل� 
 </p>
 </div>
 ...
 <div className="text-primary text-sm font-bold">قهو� كوب</div>
 </div>
