  ...
  const createEmployeeMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "تم إضافة الموظف بنجاح. يمكنه الآن إنشاء كلمة المرور الخاصة به.",
      });
    },
    onError: (error: any) => {
      toast({
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-amber-500">إدارة الموظفين</h1>
              ...
              <form onSubmit={handleSubmitNew} className="space-y-4">
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                  <p className="text-sm text-amber-500/90">
                    💡 سيتم إنشاء الموظف بدون كلمة مرور. يجب على الموظف الذهاب إلى صفحة "موظف جديد" لإنشاء كلمة المرور الخاصة به.
                  </p>
                </div>
