...
export const coffeeCategories = [
 ...
 nameAr: "قهوة أساسي� ",
 nameEn: "Basic Coffee",
 description: "مجموع� من القهوة الأساسي� المحضر� بعناي� ",
 icon: "coffee"
 },
 {
 ...
 nameAr: "قهوة سا� ن� ",
 nameEn: "Hot Coffee",
 description: "تشكيل� من المشروبات السا� ن� اللذيذة ",
 icon: "fire"
 },
 {
 ...
 nameAr: "قهوة بارد� ",
 nameEn: "Cold Coffee",
 description: "مشروبات بارد� منعش� ومثلج� ",
 icon: "snowflake"
 },
 {
 id: "specialty" as CoffeeCategory,
 nameAr: "المشروبات الإضافي� ",
 nameEn: "Specialty Drinks",
 description: "تشكيل� استثنائية من المشروبات المميز� والفريد� ",
 icon: "star"
 },
 {
 ...
 nameAr: "الحلويات",
 nameEn: "Desserts",
 description: "حلويات شهي� ولذيذ� تكمل تجربة القهوة ",
 icon: "cake"
 }
];
...
export const defaultCoffeeMenu: CoffeeItem[] = [
 ...
 description: "قهوة إسبريسو مركز� من حبوب عربي� م� تار� ",
 price: "4.00",
 oldPrice: "5.00",
 category: "basic",
 ...
 description: "قهوة إسبريسو مضاعف� للباحثين عن النكه� القوي� ",
 price: "5.00",
 oldPrice: "6.00",
 category: "basic",
 ...
 nameAr: "أمريكانو",
 nameEn: "Americano",
 description: "إسبريسو م� فف بالماء السا� ن لطعم معتدل",
 price: "5.00",
 oldPrice: "6.00",
 category: "basic",
 ...
 nameAr: "ريستريتو",
 nameEn: "Ristretto",
 description: "إسبريسو مركز بنصف كمي� الماء لطعم أقوى",
 price: "5.00",
 oldPrice: "6.00",
 category: "basic",
 ...
 description: "قهوة تركي� تقليدي� محضر� بطريقة عريق� ، غني� بالنكه� والتراث",
 price: "5.00",
 oldPrice: null,
 category: "basic",
 ...
 nameAr: "كافيه لاتيه",
 nameEn: "Cafe Latte",
 description: "إسبريسو مع حليب م� فوق كريمي ورغو� ناعم� ",
 price: "5.00",
 oldPrice: "6.00",
 category: "hot",
 ...
 nameAr: "كابتشينو",
 nameEn: "Cappuccino",
 description: "مزيج متوازن من الإسبريسو والحليب والرغو� ",
 price: "5.00",
 oldPrice: "6.00",
 category: "hot",
 ...
 description: "لاتيه كلاسيكي مع نكه� الفانيلا الطبيعي� ",
 price: "6.00",
 oldPrice: "7.00",
 category: "hot",
 ...
 nameAr: "موكا",
 nameEn: "Mocha",
 description: "مزيج رائع من القهوة والشوكولات� والحليب",
 price: "7.00",
 oldPrice: "8.00",
 category: "hot",
 ...
 description: "إسبريسو مع كريم� م� فوق� طازج� ",
 price: "5.00",
 oldPrice: "6.00",
 category: "hot",
 ...
 description: "تشكيل� م� تار� يومياً من أفضل حبوب القهوة ",
 price: "4.95",
 oldPrice: "5.50",
 category: "hot",
 ...
 description: "قهوة فرنسي� فا� ر� محضر� بطريقة الكبس الفرنسي، تمنحك نكه� غني� ومميز� ",
 price: "6.00",
 oldPrice: null,
 category: "hot",
 ...
 nameAr: "شاي حار",
 nameEn: "Hot Tea",
 description: "شاي طبيعي مُحضر بعناي� من أوراق الشاي الم� تار� ، يُقدم سا� ناً ومنعشاً لبداي� يوم مثالي� ",
 price: "2.00",
 oldPrice: null,
 category: "specialty",
 ...
 nameAr: "آيس تي",
 nameEn: "Ice Tea",
 description: "انتعاش لا يُقاوم مع مزيج مثالي من الشاي المنقوع ببرود� والطعم المميز، رحل� منعش� في كل رشف� تجدد طاقتك وتمنحك لحظات من الصفاء",
 price: "3.00",
 oldPrice: null,
 category: "specialty",
 ...
 description: "إبداع ياباني ساحر يجمع بين نعوم� الحليب المثلج وسحر الماتشا الأ� ضر النقي، تجربة بصري� وذوقي� استثنائية تأ� ذك في رحل� إلى عالم من الهدوء والتميز",
 price: "10.00",
 oldPrice: null,
 category: "specialty",
 ...
 description: "دفء ساحر يلتقي مع نكه� الماتشا الاستثنائية في لحن متناغم من الكريم� والطعم الياباني الأصيل، يُقدم سا� ناً بفن لاتيه مبهر يسعد العين قبل أن يأسر الذوق",
 price: "11.00",
 oldPrice: null,
 category: "specialty",
 ...
 nameAr: "آيسد موكا",
 nameEn: "Iced Mocha",
 description: "موكا بارد� مع الشوكولات� والكريم� الم� فوق� ",
 price: "7.00",
 oldPrice: "8.00",
 category: "cold",
 ...
 description: "كابتشينو بارد مع رغو� الحليب المثلج� ",
 price: "6.00",
 oldPrice: "7.00",
 category: "cold",
 ...
 {
 id: "iced-condensed",
 nameAr: "قهوة مثلج� بالحليب المكثف",
 nameEn: "Iced Coffee with Condensed Milk",
 description: "قهوة بارد� مع حليب مكثف حلو ولذيذ",
 price: "5.00",
 oldPrice: "6.00",
 category: "cold",
 ...
 description: "قهوة بارد� منقوع� ببطء مع نكه� الفانيلا",
 price: "6.00",
 oldPrice: "7.00",
 category: "cold",
 ...
 nameAr: "كولد برو",
 nameEn: "Cold Brew",
 description: "قهوة بارد� منقوع� ببطء لمد� 12 ساع� ، نكه� ناعم� وغني� بطعم القهوة الأصيل� ",
 price: "4.95",
 oldPrice: "5.50",
 category: "cold",
 ...
 description: "تشكيل� م� تار� يومياً من القهوة البارد� المنعش� ",
 price: "4.95",
 oldPrice: "5.50",
 category: "cold",
 ...
 description: "حلى قهوة فا� ر في كوب، طبقات من الكريم� والقهوة والبسكويت المطحون، تجربة حلو� لا تُنسى",
 price: "8.00",
 oldPrice: null,
 category: "desserts",
