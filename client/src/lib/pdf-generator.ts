...
export const generatePDF = async (
 ...
 'qahwa-card': 'مشروب مجاني من بطاق� الولاء'
 };
 ...
 <p style="color: #8B6F47; font-size: 18px; margin: 12px 0 8px 0; font-weight: 600;">🌟 تجرب� قهو� استثنائي� 🌟</p>
 <p style="color: #666; font-size: 16px; margin: 8px 0 0 0; font-style: italic; font-weight: 500;">
 "لكل لحظ� قهو� ، لحظ� نجاح"
 </p>
 </div>
 ...
 <h2 style="color: #D4AF37; font-size: 28px; margin-bottom: 15px; font-weight: bold; text-align: center; background: linear-gradient(135deg, #D4AF37, #F4D03F); -webkit-background-clip: text; color: transparent; text-shadow: 2px 2px 4px rgba(212, 175, 55, 0.3);">✨ فاتور� استلام الطلب ✨</h2>
 ...
 <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
 <span style="font-weight: bold; color: #8B6F47;">📅 التاري� :</span>
 ...
 <th style="padding: 12px; text-align: center; border: 1px solid #ddd; font-weight: bold;">الكمي� </th>
 ...
 <div style="margin-bottom: 30px;">
 <h3 style="color: #D4AF37; font-size: 20px; margin-bottom: 15px; font-weight: bold;">طريق� الدفع</h3>
 <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
 <span style="font-weight: bold;">الطريق� :</span>
 ...
 <span style="font-weight: bold;">🔗 رمز الاستجاب� السريع:</span> يحتوي على رابط موقع قهو� كوب
 </p>
 <p style="margin: 8px 0 0 0; font-size: 12px; text-align: center; color: #8B6F47;">
 امسح الرمز للوصول إلى <span style="font-weight: bold; color: #D4AF37;">qahwa.ma3k.online</span> وطلب المزيد من منتجاتنا اللذيذ� 
 </p>
 </div>
 ...
 <p style="margin: 0; font-size: 20px; font-weight: bold; color: #B8860B;">🌟 شكراً لا� تياركم قهو� كوب 🌟</p>
 <p style="margin: 8px 0; font-size: 16px; font-style: italic; color: #8B6F47;">☕ "لكل لحظ� قهو� ، لحظ� نجاح" ☕</p>
 <p style="margin: 15px 0 5px 0; font-size: 13px; color: #666; font-weight: 500;">
 📄 تم إنشاء فاتور� الاستلام هذه إلكترونياً
 </p>
